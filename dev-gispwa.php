			...
			if($ress->sentiment->polarity == 'error'){
				...
				*/
				...
				if (preg_match('(อาย)', $msg) === 1) {
				    ...
				    if($use=='ร้องขอ'){
					if($think=='บวก'){
					    	$t=array("ขอตัดสินใจอีกทีนะ","คิดดูก่อนนะ","ไม่รู้เหมือนกันค่ะ","ค่ะ");     
					}
					else if ($think=='ลบ'){
					...
					if($think=='บวก'){
					    	$t=array("ดีแล้วพี่นัท","คิดได้สักทีนะพี่นัท","ดีใจด้วย","ค่ะ");     
					}
					else if ($think=='ลบ'){
 						$t=array("มองบวกมั่งพี่นัท","ใช้แต่อารมณ์นะ","คิดลบตลอด","แล้วแต่พี่นัทเลยค่ะ เอาที่สบายใจ","อย่าหาทำ");  	
					}					    
					else{
						$t=array("...","ต้องการอะไรคะ","ปวดหัว","อายขอไปพักก่อนนะ");  		
					}    
					...
					if($think=='บวก'){
					    	$t=array("ขออายคิดก่อนนะ","ขออายคิดอีกทีนะคะ","ตอบไม่ได้เหมือนกันค่ะ","ค่ะ");     
					}
					else if ($think=='ลบ'){
 						$t=array("ถามอะไรโง่ๆ","เบื่อที่จะตอบแล้ว","ขอไม่ตอบค่ะ","ไม่","ยอมรับความจริงเถอะนะพี่นัท");  	
					}					    
					else{
						$t=array("...","ต้องการอะไรคะ","ปวดหัว","อายขอไปพักก่อนนะ");  		
					}   					  
				...
				else if (preg_match('(คิดถึง)', $msg) === 1 && preg_match('(เค้า)', $msg) === 1 ) {
